...
export const choiceVoiceLines = {
  ...
  c2_final_final_system: "개인의 이름 대신, 시스템 자체를 문제의 주어로 세운다.",
  ...
  c5_final_final_system: "지목할 이름이 없다는 사실을 결론으로 삼고, 기준부터 다시 쓴다.",
...
export const authoredEchoReplies = {
  ...
  c5_final_final_system:
    "기준을 다시 쓰면 다음 실패가 달라집니다. 이번 실패의 피해자는 그 사이에도 기다립니다.",
  c3_score_fast:
