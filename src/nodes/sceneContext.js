...
export const sceneContext = {
  ...
  f_start_owner: {
    ...
    clock: "시즌 마지막 밤",
    question: "끝까지 곁에 남은 당신이 '결속 유지 능력 상'으로 적혔습니다. 그 집념은 누구에게 이용될 수 있습니까?",
    lead: "트리거랩의 불이 꺼진 뒤에도 동료들과 끝까지 남았던 밤, 마지막 사람이 계단을 내려간 직후입니다.",
  },
  f_start_system: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
    question: "봉인을 풀어 달라는 당신의 요청서가 관찰 자료 1번이 됐습니다. 이 자리를 받겠습니까?",
    lead: "해체일 밤, 봉인 해제 요청서를 내고 B2에 내려와 승인 알림을 기다리던 중입니다.",
  },
  f_start_name: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
    question: "33층으로 달려간 당신의 걸음을 근거로 더 큰 통제를 하겠다고 합니다. 이 제안을 받겠습니까?",
    lead: "33층 면담이 한 시간 미뤄져 B2로 내려온 마지막 밤입니다. 당신의 빠른 걸음이 벌써 실험 자료로 올라가 있습니다.",
  },
  f_start: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
  ...
  f_choice: {
    ...
    lead: "스물네 사건과 반년, 그리고 이 밤이 지났습니다. 트리거랩의 불은 꺼졌고, 한서윤도 반재욱도 더는 말을 보태지 않습니다. 단말 앞에 남은 사람은 당신뿐입니다.",
  },
  f_witness: {
