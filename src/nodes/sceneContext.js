...
export const sceneContext = {
  ...
  c7_start: {
    ...
    lead: "인사위원회가 끝난 다음 날 아침입니다. 한서윤이 인쇄된 발령서를 들고 와 마지막 장의 빈 승인란을 먼저 보여줍니다.",
  },
  c7_start_stand: {
    place: "트리거랩 4층 · 오진우의 자리 앞",
    clock: "발령까지 48h",
    question: "그의 자리를 지켜 준 다음 주에 치워진 것은 당신의 자리입니다. 남은 이틀을 어디에 쓰겠습니까?",
    lead: "돌아올 의자를 치우지 않은 대가가 도착했습니다. 발령서 작성일은 그가 결근한 날보다 앞섭니다.",
  },
  c7_start_open: {
  ...
  c7_route_system: {
    ...
    clock: "발령까지 15h",
    question: "승인란이 빈 채 발효된 발령이 4년간 열아홉 건입니다. 이 표를 어디까지 열겠습니까?",
  },
  ...
  c8_start: {
    ...
    lead: "발령 9일째 오후 세 시, 객장이 빈 지점입니다. 휴면 법인 계좌 정리 목록의 한 줄이 분기마다 서울로 돈을 보내고 있습니다.",
  },
  c8_start_stand: {
    place: "KD은행 강원 영동지점 · 기업대출 창구",
    clock: "청산 등기까지 72h",
    question: "안부를 보내 온 사람들이 있고, 계좌는 72시간 뒤 사라집니다. 이 한 줄을 어떻게 붙잡겠습니까?",
    lead: "떠나기 전 한 명씩 만난 사람들 중 셋이 지점으로 문자를 보냈습니다. 그리고 휴면 계좌 목록에서 이상한 법인이 눈에 걸립니다.",
  },
  c8_start_open: {
    place: "KD은행 강원 영동지점 · 기업대출 창구",
    clock: "청산 등기까지 72h",
    question: "원본은 감사인에게 갔지만 돈은 아직 이 창구를 지나갑니다. 이 한 줄을 어떻게 붙잡겠습니까?",
    lead: "기차 대신 이틀 늦은 버스로 내려왔습니다. 지점장은 지각을 묻지 않았고, 휴면 계좌 하나가 대신 말을 겁니다.",
  },
  c8_start_alone: {
    place: "KD은행 강원 영동지점 · 기업대출 창구",
    clock: "청산 등기까지 72h",
    question: "아무도 당신이 무엇을 보는지 모릅니다. 조용히 발견한 이 한 줄을 어떻게 쓰겠습니까?",
    lead: "아무에게도 알리지 않고 내려온 지점입니다. 연락 오는 사람이 없으니, 휴면 계좌 목록을 끝까지 읽을 시간이 있었습니다.",
  },
  c8_trail: {
  ...
  c9_start_law: {
    ...
    lead: "흔적표는 공식 기록이 됐지만 수사 착수일은 아직 비어 있습니다. 그 사이 청산 안건이 먼저 올라왔습니다.",
  },
  c9_start_friend: {
    place: "플로우온 본사 8층 상황실",
    clock: "채권단 결의까지 60h",
  ...
  c9_calc_reaction: {
    place: "여의도 새벽 카페 · 창가 자리",
    clock: "채권단 결의까지 49h",
    question: "3억은 22년 근속한 열한 명의 퇴직금입니다. 이 숫자를 어디에 두겠습니까?",
  },
  c9_family: {
  ...
  c10_start_stay: {
    ...
    lead: "고용 승계 합의서에 마지막 서명을 받고 올라온 길입니다. 열흘 만에 본 도윤하는 침대에 있습니다.",
  },
  c10_start_court: {
    place: "강서 이음병원 · 병실",
    clock: "기록 폐기까지 96h",
  ...
  c10_claim: {
    ...
    lead: "심의장 맞은편에 반재욱이 앉아 있습니다. 그가 오늘은 수첩을 펴지 않았습니다.",
  },
  c10_pills: {
    place: "트리거랩 4층 분석관실 · 인사 대장 단말",
    clock: "산업재해 심의까지 34h",
  ...
  f_start_owner: {
    ...
    clock: "시즌 마지막 밤",
    question: "당신은 사람을 끝까지 포기하지 않았습니다. 그 집념은 누구에게 이용될 수 있습니까?",
    lead: "풀필먼트센터를 떠나 트리거랩으로 돌아온 마지막 밤입니다. 케이스데스크에 '인사평가_보조지표' 폴더가 열려 있습니다.",
  },
  f_start_system: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
    question: "법정에서 구조를 설명한 당신이 이번엔 관찰자가 됐습니다. 이 자리를 받겠습니까?",
    lead: "증언을 마치고 트리거랩으로 돌아온 마지막 밤입니다. 당신이 설명한 구조가 실험의 일부로 등록돼 있습니다.",
  },
  f_start_name: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
    question: "조용히 돌아간 당신의 침묵을 근거로 더 큰 통제를 하겠다고 합니다. 이 제안을 받겠습니까?",
    lead: "영동지점에서 호출을 받고 다시 올라온 마지막 밤입니다. 당신의 조용한 복귀가 실험 자료로 남아 있습니다.",
  },
  f_start: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
  ...
  f_choice: {
    ...
    lead: "열 사건과 몇 달, 그리고 이 밤이 지났습니다. 한서윤도 반재욱도 더는 말을 보태지 않고, 단말 앞에 남은 사람은 당신뿐입니다.",
  },
  f_witness: {
