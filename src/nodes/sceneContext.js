...
export const caseSetting = {
  ...
  case03: { place: "세움테크 입찰 대기실", clock: "입찰 마감까지 4h" },
...
export const sceneContext = {
  ...
  competitor: {
    ...
    lead: "현장에서 본사로 돌아오자 넥스트마일의 인수 제안서가 먼저 도착해 있었습니다. 같은 자리에 트리거랩 분석관 오진우도 앉아 있습니다.",
  },
  board: {
  ...
  c3_start_audit: {
    ...
    lead: "감사실을 나와 고객사 세움테크의 입찰장으로 이동했습니다. 오진우는 옆방에서 같은 자료를 받고 있습니다.",
  },
  c3_start_person: {
    place: "세움테크 입찰 대기실",
    clock: "입찰 마감까지 4h",
    question: "이민서를 지킨 선택이 약점으로 불립니다. 그 기준을 이번에도 유지하겠습니까?",
    lead: "감사실을 나와 고객사 세움테크의 입찰장으로 이동했습니다. 오진우는 지난 사건의 당신을 이미 읽고 왔습니다.",
  },
  c3_start_public: {
    place: "세움테크 입찰 대기실",
    clock: "입찰 마감까지 4h",
    question: "유출 가능성을 밖에 알린 뒤 시선이 모였습니다. 이번 싸움은 해결안입니까, 경보의 통제권입니까?",
    lead: "감사실을 나와 고객사 세움테크의 입찰장으로 이동했습니다. 당신이 만든 경보가 입찰장까지 따라왔습니다.",
  },
  c3_start: {
    place: "세움테크 입찰 대기실",
    clock: "입찰 마감까지 4h",
    question: "오진우가 옆방에서 같은 자료로 경쟁안을 씁니다. 속도와 검증 중 무엇을 먼저 택하겠습니까?",
    lead: "감사실을 떠나 세움테크 입찰장으로 이동했습니다. 이 회사도 KD은행에서 1,240억을 빌려 쓰고 있고, 공사 대금은 그룹 계열사로 들어옵니다. 당신과 오진우는 같은 자료를 받고 다른 방에 앉았습니다.",
  },
  c3_split: {
    place: "세움테크 입찰 대기실",
    clock: "입찰 마감까지 3h",
  ...
  c4_start_joint: {
    ...
    lead: "입찰장을 떠나 돌봄 플랫폼 온새의 운영 검토실로 왔습니다. 오진우도 같은 자리에 앉아 있습니다.",
  },
  c4_start_proof: {
    place: "온새 운영 검토실",
    clock: "지원금 심사까지 9h",
    question: "정직함 때문에 서비스를 잃을 사람이 생겼습니다. 같은 기준을 여기서도 지키겠습니까?",
    lead: "입찰장을 떠나 돌봄 플랫폼 온새의 운영 검토실로 왔습니다. 보안 결함을 공개한 기록이 당신보다 먼저 도착했습니다.",
  },
  c4_start_win: {
    place: "온새 운영 검토실",
    clock: "지원금 심사까지 9h",
    question: "이긴 기록이 다음 사건의 기준이 됐습니다. 결과가 좋다면 규칙을 넓힐 수 있습니까?",
    lead: "입찰장을 떠나 돌봄 플랫폼 온새의 운영 검토실로 왔습니다. 당신의 승리 방식이 이미 참고 자료가 되어 있습니다.",
  },
  c4_start: {
    place: "온새 운영 검토실",
    clock: "지원금 심사까지 9h",
    question: "지표가 3% 모자라 4,200명의 돌봄이 끊깁니다. 산식 해석을 넓히겠습니까, 그대로 보고하겠습니까?",
    lead: "입찰장을 떠나 돌봄 플랫폼 온새의 운영 검토실로 왔습니다. 모자란 3%는 지난 분기 KD은행이 상환 일정을 앞당기면서 생겼습니다. 트리거랩은 이번에 '명분 있는 위반의 허용선'을 봅니다.",
  },
  c4_offer: {
    place: "온새 운영 검토실",
    clock: "지원금 심사까지 7h",
  ...
  c5_start: {
    ...
    lead: "온새를 떠나 도시형 돌봄 배차 시스템의 복구 통제실로 왔습니다. 언론은 책임자를 요구하는데, 첫 자료에는 규정을 어긴 사람이 없습니다. 규정을 따라 올라가면 맨 위에 사람 대신 예산 상한선이 있습니다.",
  },
  c5_map: {
  ...
  f_start_owner: {
    ...
    lead: "복구 통제실을 떠나 트리거랩으로 돌아온 마지막 밤입니다. 케이스데스크에 '인사평가_보조지표' 폴더가 열려 있습니다.",
  },
  f_start_system: {
    place: "트리거랩 기록 보관소 B2",
    clock: "시즌 마지막 밤",
  ...
  f_choice: {
    ...
    lead: "일곱 사건과 엿새, 그리고 이 밤이 지났습니다. 한서윤도 반재욱도 더는 말을 보태지 않고, 단말 앞에 남은 사람은 당신뿐입니다.",
  },
  f_witness: {
