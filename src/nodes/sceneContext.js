...
const caseSetting = {
  ...
  case12: { place: "트리거랩 4층 분석관실", clock: "분쟁조정 신청 마감까지 D-10" },
...
export const sceneContext = {
  ...
  c3_start_audit: {
    ...
    lead: "감사실을 나와 고객사 노바웍스의 입찰장으로 이동했습니다. 오진우는 옆방에서 같은 자료를 받고 있습니다.",
  },
  c3_start_person: {
    place: "노바웍스 입찰 대기실",
    clock: "입찰 마감까지 4h",
    question: "이민서를 지킨 선택이 약점으로 불립니다. 그 기준을 이번에도 유지하겠습니까?",
    lead: "감사실을 나와 고객사 노바웍스의 입찰장으로 이동했습니다. 오진우는 지난 사건의 당신을 이미 읽고 왔습니다.",
  },
  c3_start_public: {
    place: "노바웍스 입찰 대기실",
    clock: "입찰 마감까지 4h",
    question: "유출 가능성을 밖에 알린 뒤 시선이 모였습니다. 이번 싸움은 해결안입니까, 경보의 통제권입니까?",
    lead: "감사실을 나와 고객사 노바웍스의 입찰장으로 이동했습니다. 당신이 만든 경보가 입찰장까지 따라왔습니다.",
  },
  c3_start: {
    place: "노바웍스 입찰 대기실",
    clock: "입찰 마감까지 4h",
    question: "오진우가 옆방에서 같은 자료로 경쟁안을 씁니다. 속도와 검증 중 무엇을 먼저 택하겠습니까?",
    lead: "감사실을 떠나 노바웍스 입찰장으로 이동했습니다. 이 회사도 KD은행에서 1,240억을 빌려 쓰고 있고, 공사 대금은 그룹 계열사로 들어옵니다. 당신과 오진우는 같은 자료를 받고 다른 방에 앉았습니다.",
  },
  c3_split: {
    place: "노바웍스 입찰 대기실",
    clock: "입찰 마감까지 3h",
  ...
  f_choice: {
    ...
    lead: "열두 사건과 몇 달, 그리고 이 밤이 지났습니다. 한서윤도 반재욱도 더는 말을 보태지 않고, 단말 앞에 남은 사람은 당신뿐입니다.",
  },
  f_witness: {
