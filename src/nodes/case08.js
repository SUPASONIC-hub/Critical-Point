...
export const case08Nodes = {
  c8_start: {
    ...
    speaker: "나준혁",
    text:
      "강원 영동지점 부임 9일째. 휴면 법인 계좌(오래 거래가 끊긴 회사 계좌)를 정리하다 한 줄에서 손이 멈춥니다. 경포 펜션 주소로 등록된 컨설팅 회사 해온파트너스. 3년 전부터 분기마다 자문료가 들어오고, 같은 날 전액이 서울 청담동의 한 갤러리로 나갑니다. 그리고 오늘 아침, 이 회사의 청산(회사를 정리해 없애는 절차) 신청서가 접수됐습니다. 나준혁 지점장이 믹스커피를 내려놓습니다. '그 계좌, 전임자가 세 번 올렸다가 세 번 다 반려됐어요.'",
    memo: [
      "해온파트너스: 분기 자문료 입금 당일 전액 출금",
      "입금처: 세움테크, 브릿지은행 계열 자문사",
      "출금처: 청담동 갤러리 온",
  ...
  c8_gallery: {
    ...
    speaker: "반재욱",
    text:
      "청담동 갤러리 온. 사표가 수리된 반재욱이 관람객처럼 서서 가격표를 수첩에 옮겨 적습니다. 무명 작가의 소품 열두 점, 점당 1억 2천. 구매자는 전부 세움테크와 브릿지은행의 협력사이고, 작가는 브릿지은행 남궁현 부행장의 조카입니다. '그림은 좋은 도구입니다. 값이 정해져 있지 않으니까. 비싸게 사 주면 그게 곧 뇌물이죠.' 그가 수첩을 덮지 않습니다. '나는 이제 감사역이 아니라서, 이걸 적어도 낼 곳이 없습니다. 그래도 적습니다.'",
    memo: [
      "소품 12점 × 1억 2천 = 14억 4천",
      "구매자 전원이 세움테크·브릿지은행 협력사",
  ...
  c8_final: {
    ...
    speaker: "오진우",
    text:
      "청산 등기까지 5시간. 해온파트너스의 자문료, 갤러리의 그림값, 그리고 3년 전 2023-0412의 빈 서명란이 하나의 흔적표로 이어졌습니다. 오진우가 파일을 넘기기 전에 묻습니다. '이걸로 그 사람을 무너뜨릴 수 있습니다. 그런데 무너뜨리는 게 목적이면, 저는 그 사람하고 뭐가 다릅니까.' 칼을 누구 손에 쥐여 줄지가 남았습니다.",
    memo: [
