...
export const case05Nodes = {
  c5_start: {
    ...
    speaker: "반재욱",
    text:
      "도시형 돌봄 배차 시스템에서 대규모 누락 사고가 났습니다. 312명이 예정된 방문 서비스를 받지 못했고, 언론은 책임자를 요구합니다. 그런데 첫 자료를 보면 모두가 규정대로 행동했습니다. 반재욱이 수첩을 펼칩니다. '규정을 따라 올라가 봤습니다. 맨 위에 있는 건 사람이 아니라 예산 상한선이고, 그 상한선은 온새 상환 조건표에서 그대로 내려왔습니다.'",
    memo: [
      "서비스 누락: 312명",
      "현장 직원은 안내서대로 처리",
      "배차 시스템은 승인된 기준대로 작동",
