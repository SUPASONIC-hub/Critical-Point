...
export const case01Nodes = {
  ...
  accounting: {
    ...
    speaker: "반재욱",
    text:
      "재무책임자가 8개월간 매출을 장부에 올리는 시점을 바꿔 왔습니다. 개인이 돈을 빼돌린 흔적은 없습니다. 바꾼 이유는 단순합니다. KD은행 대출 계약서 제7조가 부채비율(회사 빚이 자기 돈의 몇 배인지 보는 숫자) 180%를 넘기면 은행이 만기 전이라도 대출금을 즉시 회수할 수 있게 해 두었고, 손대기 전 수치는 184%였습니다. 반재욱이 계약서를 넘기며 묻습니다. '이 조항을 쓴 쪽이 이 숫자를 만들게 한 겁니다. 그럼 조작한 사람은 누굽니까?'",
    memo: [
