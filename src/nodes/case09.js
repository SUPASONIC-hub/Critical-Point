...
export const case09Nodes = {
  c9_start: {
    ...
    speaker: "도윤하",
    text:
      "3년 전 KD은행이 310억을 빌려준 플로우온이 다시 채권단(돈을 빌려준 금융회사들의 협의체) 결의를 앞두고 있습니다. 이번 안건은 회생(빚을 조정해 회사를 살리는 절차)이 아니라 청산(회사를 정리해 없애는 절차)입니다. 직원 1,140명, 협력사 280곳. 청산을 밀어붙이는 쪽은 선순위 담보(회사가 무너지면 가장 먼저 돈을 가져갈 권리)를 쥔 브릿지은행이고, 그 대표로 나온 심사역은 창업주의 장남 권도현입니다. 도윤하가 채권단 명단을 내려놓습니다. '가업을 거절하고 은행에 간 사람이, 이번엔 은행 쪽에서 아버지 회사를 닫으러 왔어요.'",
    memo: [
      "채권단 결의까지 60시간, 안건: 청산",
      "직원 1,140명 · 협력사 280곳",
  ...
  c9_timing: {
    ...
    speaker: "오진우",
    text:
      "오진우가 돌아왔습니다. 수염은 깎지 않았지만 반찬통은 비워서 들고 왔습니다. 그가 달력 한 칸에 동그라미를 칩니다. '금융감독원이 브릿지은행을 정기검사(은행의 영업 전반을 들여다보는 정기 조사)하러 모레 아침 9시에 들어갑니다. 흔적표를 그 전날 밤에 넣으면, 검사반은 담보 순위(누가 먼저 돈을 받느냐의 순서)를 사들인 거래를 첫날부터 봅니다.' 브릿지은행이 제재를 받으면 선순위 담보(가장 먼저 돈을 가져갈 권리)가 묶이고 청산 결의는 힘을 잃습니다. 다만 그 은행에는 권도현이 있습니다.",
    memo: [
