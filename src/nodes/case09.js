...
export const case09Nodes = {
  c9_start: {
    ...
    speaker: "도윤하",
    text:
      "3년 전 KD은행이 310억을 빌려준 플로우온이 다시 채권단(돈을 빌려준 금융회사들의 협의체) 결의를 앞두고 있습니다. 이번 안건은 회생(빚을 조정해 회사를 살리는 절차)이 아니라 청산입니다. 직원 1,140명, 협력사 280곳. 청산을 밀어붙이는 쪽은 선순위 담보(회사가 무너지면 가장 먼저 돈을 가져갈 권리)를 쥔 브릿지은행이고, 그 대표로 나온 심사역은 창업주의 장남 권도현입니다. 도윤하가 채권단 명단을 내려놓습니다. '가업을 거절하고 은행에 간 사람이, 이번엔 은행 쪽에서 아버지 회사를 닫으러 왔어요.'",
    memo: [
      "채권단 결의까지 60시간, 안건: 청산",
      "직원 1,140명 · 협력사 280곳",
  ...
  c9_family: {
    ...
    speaker: "반재욱",
    text:
      "반재욱이 3년 전 플로우온 장부 원본을 펼칩니다. 사건 01에서 누가 만들었는지 끝내 밝히지 못한 매출채권(아직 받지 못한 판매 대금) 179.6억. 만든 사람은 대표이사 권승우와 CFO(재무 책임자) 배성준, 권도현의 작은아버지와 고모부입니다. 장부를 부풀린 분식회계, 회삿돈으로 산 골프 회원권, 해온파트너스로 나간 자문료까지. 배임(맡은 회사에 손해를 끼친 죄)과 횡령(회삿돈을 빼돌린 죄)이 한 장부에 같이 있습니다. 권도현이 한 장씩 넘기다 멈춥니다. '작은아버지가 제 대학 등록금을 내줬습니다. 그 돈이 어디서 나왔는지, 이제 알겠네요.'",
    memo: [
  ...
  c9_timing: {
    ...
    speaker: "오진우",
    text:
      "오진우가 돌아왔습니다. 수염은 깎지 않았지만 반찬통은 비워서 들고 왔습니다. 그가 달력 한 칸에 동그라미를 칩니다. '금융감독원이 브릿지은행을 정기검사(은행의 영업 전반을 들여다보는 정기 조사)하러 모레 아침 9시에 들어갑니다. 흔적표를 그 전날 밤에 넣으면, 검사반은 담보 순위(누가 먼저 돈을 받느냐의 순서)를 사들인 거래를 첫날부터 봅니다.' 브릿지은행이 제재를 받으면 선순위 담보가 묶이고 청산 결의는 힘을 잃습니다. 다만 그 은행에는 권도현이 있습니다.",
    memo: [
  ...
  c9_final: {
    ...
    speaker: "권도현",
    text:
      "채권단 결의 3시간 전. 권도현이 계산서 두 장을 나란히 놓습니다. 왼쪽은 플로우온을 살리는 계산서, 출자전환(빌려준 돈을 회사 지분으로 바꾸기)과 고용 승계(직원을 해고 없이 그대로 넘겨받기). 오른쪽은 무너뜨린 사람을 벌하는 계산서, 고발장과 흔적표와 검사반 제보. '둘 다 맞는 계산입니다. 문제는 두 장이 한 테이블에 올라가면 채권단이 겁을 먹는다는 거죠.' 그가 펜을 내밉니다. '어느 장에 서명하시겠습니까. 아니면 둘 다입니까.'",
    memo: [
