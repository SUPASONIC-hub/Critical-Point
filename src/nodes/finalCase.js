  ...
  f_start: {
    ...
    choices: [
      ...
      },
      {
        ...
        effect: { trust: 4, legitimacy: 6, fatigue: 3 },
        next: "f_archive",
        cognition: { risk: 2 },
      },
      {
        ...
        effect: { trust: 5, legitimacy: 1, fatigue: 2 },
        next: "f_archive",
    ...
    choices: [
      {
        ...
        effect: { legitimacy: 5, trust: -4, fatigue: 4 },
        next: "f_confront",
    ...
    choices: [
      {
        ...
        effect: { legitimacy: 4, trust: -2, fatigue: 2 },
        next: "f_choice",
        cognition: { risk: 2 },
      },
      {
        ...
        effect: { trust: 8, legitimacy: 5, fatigue: 5 },
        next: "f_choice",
    ...
    choices: [
      {
        ...
        effect: { legitimacy: 5, trust: -4, fatigue: 2 },
        next: "final_result",
        cognition: { risk: 2 },
      },
      {
        ...
        effect: { trust: 8, legitimacy: 5, fatigue: 4 },
        next: "final_result",
        cognition: { reframing: 3 },
      },
      {
