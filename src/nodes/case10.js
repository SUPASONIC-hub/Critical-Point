...
export const case10Nodes = {
  ...
  c10_claim: {
    ...
    speaker: "반재욱",
    text:
      "산업재해(일하다 생긴 병이나 다침을 회사와 국가가 함께 책임지는 제도) 심의가 열렸습니다. 쟁점은 하나입니다. 탈진이 업무 때문이라는 걸 증명하려면, 도윤하가 규정 밖에서 얼마나 무리했는지를 기록으로 내야 합니다. 그 기록은 동시에 그가 3년간 사규를 어긴 증거입니다. 반재욱이 수첩을 덮고 처음으로 자기 손을 봅니다. '20년 동안 이 자리에서 사람을 잘랐습니다. 오늘은 이 서류가 저 사람을 살리는지 자르는지 저도 모르겠습니다.'",
    memo: [
  ...
  c10_final: {
    ...
    speaker: "도윤하",
    text:
      "도윤하가 2주 만에 돌아옵니다. 명단은 이제 제도가 됐고, 제도가 되면서 212명이 빠졌습니다. 서류가 남지 않은 사람, 대출 명의가 가족이던 사람, 이미 시효가 지난 사람. 규정은 그들을 담을 칸이 없습니다. 도윤하가 책상에 앉아 새 수첩을 꺼내 첫 장에 212라고 적습니다. 그리고 당신을 봅니다. '알아요. 이러다 또 쓰러진다는 거. 그런데 이 212명은 제가 안 적으면 아무 데도 없어요. 말려 주실 겁니까, 같이 적으실 겁니까.'",
    memo: [
