...
export const case15 = {
  ...
  routePlan: {
    ...
    system: {
      ...
      title: "실수의 주인",
      speaker: "에코",
      text: "준비된 보기 밖의 문장을 쓰자 에코가 KD은행 지난 10년의 내부 사고 보고서 1,284건을 엽니다. 원인이 '개인 조작 실수'로 닫힌 사고는 342건. 그중 243건이 계약직이나 파견직의 이름으로 닫혔고, 231건에 확인서가 붙어 있습니다. 서명한 사람 가운데 1년 안에 정규직이 된 사람은 188명입니다. 그리고 97건은 나중에 같은 원인으로 사고가 또 났습니다. '실수는 가장 싸게 계약된 사람에게 배정되도록 학습되어 있습니다. 원인은 닫혔고, 사고는 계속됩니다.'",
