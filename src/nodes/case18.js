...
export const case18 = {
  ...
  reactionScenes: [
    ...
    ["c18_snow_reaction", "c18_snow", "c18_final", "가격표의 이름", "권도현", "밤 11시, 서울로 가는 버스 안에서 권도현의 전화를 받습니다. '도 본부장님이 서명을 12월 28일 아침 9시로 못 박았습니다. 오진우 씨가 오든 안 오든 그날 가격이 확정됩니다.' 수화기 너머로 계산기 두드리는 소리가 들립니다. '그 가격표에 제 이름이 들어갑니다. 19%로 쓰면 우리는 흑자, KD는 적자, 소담찬방은 경매입니다. 23%로 쓰면 저는 이 은행에서 제일 비싼 심사역이 되고요.' 그가 짧게 웃습니다. '살면서 제 이름값을 계산해 본 건 처음입니다. 이 가격이면 적자입니다. 제 쪽이요.'", ["23%를 쓸 근거를 권도현과 밤새 같이 만든다", "가격은 권도현의 판단에 맡기고 기록만 남기라고 한다", "19% 그대로 쓰고 다음 싸움에 이름을 아끼라고 한다"]],
  ],
  reactionEffects: {
    c18_appendix: [
