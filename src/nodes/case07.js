...
export const case07Nodes = {
  c7_start: {
    ...
    speaker: "한서윤",
    text:
      "인사 발령서가 도착했습니다. 강원 영동지점 여신담당, 48시간 뒤 발효. 징계가 아니라 인사이므로 이의 절차도, 사유 고지도 없습니다. 한서윤이 종이를 뒤집어 마지막 장을 보여줍니다. 최종 승인란이 비어 있습니다. '3년 전 그 서류하고 같은 모양입니다. 이 사람은 이름을 안 씁니다. 자리를 씁니다.'",
    memo: [
      "발효까지 48시간, 이의 절차 없음",
      "발령 문서 최종 승인란: 공란",
      "기안 일자는 사건 06 개시보다 12일 앞섬",
  ...
  c7_final: {
    ...
    speaker: "오진우",
    text:
      "발효까지 6시간. 마지막 한 조각은 오진우의 진술입니다. 결정 제한시간이 설정값이었다고 말할 수 있는 사람은 그 조건을 겪은 본인뿐입니다. 그가 책상 정리를 멈추고 묻습니다. '그 문서에 이름이 몇 개 올라갑니까.' 그리고 덧붙입니다. '저는 아버지 이름을 30년 동안 그 서류에서 못 지웠습니다. 이번엔 누구 이름이 남는지 먼저 알고 싶습니다.'",
    memo: [
      "제출 가능한 자료: 수첩, 창구 뒷장, 종이 원본, 오진우 진술",
      "이름이 많을수록 증거력은 오르고 피해 범위도 넓어짐",
      "발효 6시간 뒤 열람 권한이 지점 범위로 축소",
