...
export const case07Nodes = {
  c7_start: {
    ...
    speaker: "한서윤",
    text:
      "인사 발령서가 도착했습니다. 강원 영동지점 기업대출 담당, 48시간 뒤 발효. 징계가 아니라 인사이므로 이의 절차도, 사유 고지도 없습니다. 한서윤이 종이를 뒤집어 마지막 장을 보여줍니다. 최종 승인란이 비어 있습니다. '3년 전 그 서류하고 같은 모양입니다. 이 사람은 이름을 안 씁니다. 자리를 씁니다.'",
    memo: [
      "발효까지 48시간, 이의 절차 없음",
      "발령 문서 최종 승인란: 공란",
