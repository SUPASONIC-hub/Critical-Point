...
export const case21 = {
  ...
  branchScenes: {
    ...
    c21_branch_rind_follow: {
      ...
      title: "별표 열네 개",
      speaker: "권도현",
      text: "오후 네 시, 구좌 농협 대출 창구. 고은비가 만기 연장 신청서를 받습니다. 열네 장입니다. 직원이 형광펜으로 서명할 곳에 별표를 쳐 주며 말합니다. '다 읽으실 필요는 없고요, 별표만 하시면 돼요.' 펜을 들던 고은비가 멈춥니다. 할아버지가 2년 전에 들은 말과 똑같습니다. 옆에 앉은 권도현이 빈 종이에 세로줄을 하나 긋습니다. '연장해 주는 대신 금리를 1.8%포인트 올리는 조항이 9쪽에 있습니다. 거기엔 별표가 없고요.' 고은비가 권도현을 처음으로 똑바로 봅니다.",
