...
export const case04Nodes = {
  c4_start: {
    ...
    speaker: "한서윤",
    text:
      "돌봄 플랫폼 온새가 정부 지원금 심사 직전입니다. 통과하면 취약계층 4,200명의 돌봄이 유지됩니다. 심사 항목 하나가 기준에 3% 모자랍니다. 그 항목은 이용자 한 명당 대면 돌봄 시간이고, 온새가 지난 분기에 돌봄 인력을 줄여서 떨어졌습니다. 인력을 줄인 이유는 KD은행이 운영자금 대출의 상환 일정을 갑자기 앞당겼기 때문입니다. 요구한 부서는 기업금융전략팀입니다. 이제 이 점수를 내는 산식(점수를 계산하는 공식)을 손댈지 말지가 오늘의 문제입니다.",
    memo: [
      "서비스 중단 시 4,200명 영향",
      "부족분: 정확히 3.0%",
  ...
  c4_offer: {
    ...
    speaker: "도윤하",
    text:
      "현장 담당자들은 말합니다. '숫자 3% 때문에 서비스를 끊는 게 더 비윤리적입니다.' 도윤하가 상환 일정 변경 승인 서류를 꺼냅니다. 맨 위 칸이 비어 있습니다. 사건 01의 그 보고서와 같은 모양입니다. '3%를 만든 사람은 이 칸에 이름이 없고, 3%를 메우라는 요구는 여기 사람들이 받고 있습니다.' 반재욱은 계산 공식을 손대고 기록을 남기지 않으면 그건 명백한 은폐라고 경고합니다.",
    memo: [
      "돌봄 대기자 640명",
