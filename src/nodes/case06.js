...
export const case06Nodes = {
  c6_start: {
    ...
    speaker: "한서윤",
    text:
      "경쟁 분석관 오진우가 사흘째 출근하지 않았습니다. 그의 자리에는 제출되지 않은 사건 05 검토 보고서가 열린 채 남아 있습니다. 그룹은 배차 실패의 공식 책임자로 그를 세우려 하고, 인사위원회는 이틀 뒤입니다. 한서윤이 덧붙입니다. '그룹전략실에서 내려온 안입니다. 파견 직원은 그룹 인사 기록에 남지 않습니다. 정리하기 제일 쉬운 사람이라는 뜻입니다.'",
    memo: [
  ...
  c6_panel: {
    ...
    speaker: "오진우",
    text:
      "인사위원회 대기실에서 오진우가 처음으로 당신을 봅니다. 그는 넥타이를 고쳐 매고 말합니다. '변호하지 마십시오.' 설정값 이야기를 꺼내면 자기가 빨랐다는 사실까지 설정으로 읽힌다는 것을 그는 이미 압니다. 그가 지키고 싶은 것은 경력이 아니라 그 한 가지입니다. '아버지도 그랬습니다. 억울한 걸 증명하려다 평생 억울한 사람으로 정리됐어요.'",
    memo: [
