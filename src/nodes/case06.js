 ...
 * yours. It also collects two threads the graph had left hanging -- `c3_trap`
 * and `f_confront` both say 오진우 may have been given his own pressure
 * condition, and nothing ever answered them.
 */
export const case06Nodes = {
  c6_start: {
    ...
    speaker: "한서윤",
    text:
      "경쟁 분석관 오진우가 사흘째 출근하지 않았습니다. 그의 자리에는 제출되지 않은 사건 05 검토 보고서가 열린 채로 남아 있습니다. 트리거랩은 배차 실패의 공식 책임자로 그를 세우려 하고, 인사위원회는 이틀 뒤입니다.",
    memo: [
      "오진우는 배차 가중치 검토의 승인자였음",
      "사흘간 연락 두절, 사직서는 제출되지 않음",
      "인사위원회까지 48시간",
      "이번 사건의 조사 대상은 외부 기관이 아니라 내부 동료",
    ],
  ...
  c6_desk: {
    ...
    speaker: "도윤하",
    text:
      "오진우의 책상은 그대로입니다. 펜은 모니터와 나란히 각도가 맞춰져 있고, 포스트잇은 색깔별로 줄을 섰습니다. 도윤하가 말합니다. '저 사람 화분, 제가 두 달째 물 주고 있었어요. 본인은 모릅니다.' 서랍 안쪽에는 뜯지 않은 수면제 상자가 있습니다.",
    memo: [
      "최근 3주간 퇴근 기록이 모두 자정 이후",
      "제출 직전에 지운 보고서 초안이 11개",
      "책상 달력의 마지막 표시는 사건 05 발표일",
      "화분에는 물이 넘칠 만큼 주어져 있었음",
    ],
  ...
  c6_logs: {
    ...
    speaker: "에코",
    text:
      "오진우의 실험 프로필이 열립니다. 그는 당신과 같은 연구의 반대편에 배정돼 있었습니다. 당신의 결정 창이 조금씩 길어지는 동안, 그의 창은 시즌 내내 조금씩 짧아졌습니다. 사건 03의 그 속도는 재능이 아니라 설정값이었습니다. 그는 그 사실을 모릅니다.",
    memo: [
      "오진우의 결정 제한시간: 45초 → 31초로 단계적 축소",
  ...
  c6_panel: {
    ...
    speaker: "오진우",
    text:
      "인사위원회 대기실에서 오진우가 처음으로 당신을 봅니다. 그는 넥타이를 고쳐 매고 말합니다. '변호하지 마십시오.' 설정값 이야기를 꺼내면 자기가 빨랐다는 사실까지 설정으로 읽힌다는 것을, 그는 이미 알고 있습니다. 그가 지키고 싶은 것은 경력이 아니라 그 한 가지입니다.",
    memo: [
  ...
  c6_final: {
    ...
    speaker: "한서윤",
    text:
      "위원회는 결론을 요구합니다. 오진우를 책임자로 세우면 사건 05는 오늘 닫히고, 설정값을 꺼내면 트리거랩 전체가 조사 대상이 됩니다. 어느 쪽이든 옆자리 사람의 이름이 값으로 쓰입니다. 당신은 이제 자신의 프로필도 같은 폴더에 있다는 것을 압니다.",
    memo: [
      "책임자를 세우면 사건 05는 즉시 종결",
      "설정값을 꺼내면 실험 전체가 열림",
      "오진우는 어느 쪽에도 동의하지 않음",
      "다음 사건에서 같은 폴더가 당신의 이름으로 열림",
    ],
