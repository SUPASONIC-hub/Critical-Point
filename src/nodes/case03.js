    ...
    choices: [
      {
        ...
        effect: { time: 8, trust: -4, legitimacy: -3, fatigue: 2 },
        next: "c3_split",
        cognition: { risk: 1 },
      },
      {
      ...
      },
      {
        ...
        effect: { time: -6, trust: 1, fatigue: 2 },
        next: "c3_split",
    ...
    choices: [
      {
        ...
        effect: { capital: 12, legitimacy: -5, trust: -3, fatigue: 2 },
        next: "c3_score",
        cognition: { risk: 2 },
      },
      {
        ...
        effect: { time: -10, capital: -4, legitimacy: 5, fatigue: 4 },
        next: "c3_score",
        cognition: { inference: 2, persistence: 1 },
      },
      {
    ...
    choices: [
      {
        ...
        effect: { time: 5, capital: 8, legitimacy: -4, fatigue: 2 },
        next: "c3_trap",
        cognition: { risk: 1 },
      },
      {
    ...
    choices: [
      {
        ...
        effect: { capital: 10, trust: -6, legitimacy: -5, fatigue: 2 },
        next: "c3_final",
        cognition: { risk: 2 },
      },
      {
        ...
        effect: { time: -4, trust: 6, legitimacy: 6, fatigue: 4 },
        next: "c3_final",
    ...
    choices: [
      {
        ...
        effect: { capital: 14, trust: -5, legitimacy: -4, fatigue: 2 },
        next: "case03_result",
        cognition: { risk: 2 },
      },
      {
        ...
        effect: { capital: -6, trust: 4, legitimacy: 7, fatigue: 4 },
        next: "case03_result",
