 ...
 *
 * The bid is where the bank moves the 플로우온 hole. 세움테크 borrows from the
...
export const case03Nodes = {
  c3_start: {
    ...
    speaker: "한서윤",
    text:
      "중견 제조사 세움테크의 시스템 통합 공개 입찰입니다. 세움테크는 KD은행에서 1,240억을 빌려 쓰고 있고, 이 공사 대금은 그룹 계열사로 들어옵니다. 한서윤이 담담하게 말합니다. '그 돈이 어느 계정으로 가는지는 묻지 마십시오. 대신 이것만 아십시오. 오진우도 같은 자료를 받고 옆방에서 동시에 안을 냅니다. 위에서는 이걸 경쟁 압박 아래 사고 품질 측정이라고 부릅니다. 저는 인사 자료라고 부릅니다.'",
    memo: [
      "입찰 마감까지 4시간",
      "고객사 요구: 비용 18% 절감",
      "세움테크 대출 잔액 1,240억, 주거래 KD은행",
  ...
  c3_trap: {
    ...
    speaker: "반재욱",
    text:
      "반재욱이 수첩을 덮지 않은 채 말합니다. '제보자를 찾았습니다. 세움테크 자금팀 과장입니다. 결함을 신고한 게 아니라, 이 입찰이 왜 하필 지금 나왔는지를 신고한 겁니다. 공사 대금만큼이 플로우온 손실을 장부에서 지우는 데 쓰이게 돼 있습니다.' 그리고 처음으로 당신을 똑바로 봅니다. '이건 입찰 문제가 아닙니다. 당신이 이기려 할 때 어떤 검증을 포기하는지 보는 구조입니다. 오진우도 같은 말을 들었는지는 모릅니다.'",
    memo: [
      "제보자: 세움테크 자금팀 과장",
