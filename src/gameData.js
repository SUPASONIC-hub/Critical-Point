...
const openingSignatureChoices = {
  ...
  f_start_owner: {
    ...
    cognition: { persistence: 2 },
    next: "f_route_map",
    voice: "골목의 밤이 적힌 이 파일부터, 동료들에게 먼저 공개한다.",
  ...
  f_start_system: {
    ...
    voice: "내가 묶은 공개 원칙을, 이 폴더 자신에게 먼저 적용하라고 요구한다.",
  ...
  f_start_name: {
    ...
    cognition: { reframing: 2 },
    next: "f_route_expose",
    voice: "연필로 적힌 내 이름과 이 파일을, 동료들에게 먼저 알린다.",
