...
const operatorBriefs = {
  ...
  final: {
    ...
    reason: "열두 사건의 반응 기록이 어떤 서식으로 정리됐는지, 그리고 그 서식을 주문한 사람이 누구인지 확인하기 위해",
  },
};
...
export const nextCaseSignals = {
  ...
  case12: {
    ...
    button: "마지막 사건 시작",
    premise:
      "열두 사건의 기록이 하나의 폴더로 모입니다. 그 폴더의 관리자 계정은 3년 전 서명란을 비워 둔 사람의 것입니다.",
    hook:
...
const seasonInterludes = {
  ...
  case11: {
    ...
    text: "국정감사 다음 주, 리드라인이 편집국 고양이에게 명예 기자증을 발급했습니다. 이름은 '정정'. 서하린이 사진과 함께 메시지를 보냅니다. '법무팀이 정정보도 청구를 취하했어요. 기념으로 이름 붙였어요.' 나준혁은 그 사진을 영동지점 객장 모니터 배경화면으로 바꿨고, 강태민은 야간조 단체방에 '우리 편 고양이'라고 올렸습니다. 이민서의 정규직 전환 심사 결과는 아직입니다. 그래도 그는 이번 주 처음으로 사원증을 앞면이 보이게 걸고 출근했습니다.",
  },
  case12: {
    mood: "warm",
    label: "막간 · 추석 다음 날",
