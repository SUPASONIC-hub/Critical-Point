...
export const triggerLabSignals = {
  prologue01: "관찰 항목: 맞지 않는 숫자를 만났을 때의 정지 시간, 공을 돌리는 방식, 자기 이름을 거는 문턱",
  prologue02: "관찰 항목: 정해진 결론 앞에서의 재계산 여부, 자기 팀을 겨누게 될 때의 망설임, 반대의 형태 선택",
  prologue03: "관찰 항목: 반려 통보를 받은 직후의 첫 행동, 보호한다는 말에 대한 반응, 사본을 남기는 손의 속도",
  prologue04: "관찰 항목: 판매 현장을 본 뒤의 침묵 길이, 아는 얼굴과 규칙 사이의 선택, 잡무로 내려온 일을 대하는 태도",
  prologue05: "관찰 항목: 사유 없는 결정 앞의 질문 여부, 짐에 넣는 것과 두고 가는 것, 처음 듣는 목소리에 답하는 속도",
