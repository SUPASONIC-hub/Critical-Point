...
- 타이머, 에코 반론, 위기 프로토콜, 장면별 긴장 음악
- 장면별 작전실·보안 기록소·옥상·이사회·상황실·최종 보관소 비주얼
...
음악은 브라우저 자동재생 제한을 피하기 위해 화면의 `소리 시작` 버튼을 클릭한 뒤 재생됩니다. 버튼이 현재 재생 모드와 브라우저 오디오 상태를 표시합니다.
