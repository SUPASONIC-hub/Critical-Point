-- Baseline schema for the Critical Point telemetry backend.
--
-- This file was previously supabase/schema.sql and was applied by hand in the
-- Supabase SQL Editor. It is now the baseline migration for the CLI workflow.
-- Every statement is idempotent, so re-applying it against a database that
-- already has the schema is safe.
--
-- On a project where the schema was already applied by hand, mark this as
-- applied instead of pushing it:
